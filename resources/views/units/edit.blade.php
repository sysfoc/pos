    ...
    <div class="card p-4">
        ...
        <form action="{{ route('units.update', $unit->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="unit_name" id="unit_name" class="form-control w-full border rounded p-2" value="{{ old('unit_name', $unit->unit_name) }}" required>
            </div>
            <div class="mb-4">
                <label for="short_name" class="form-label block text-gray-700">Short Name</label>
                <input type="text" name="short_name" id="short_name" class="form-control w-full border rounded p-2" value="{{ old('short_name', $unit->short_name) }}" required>
            </div>
            <div class="mb-4">
